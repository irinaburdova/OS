...
#In com_table you can see such fields: [source, destination, operation code, jump_code], if field = -1 it means that it's empty
com_table = {write: [1, 0, 0, 0], read: [0, 1, 1, 0], read_ia: [1, 1 ,1 ,0],
	write_ir: [0, 2, 0, 0], add: [0, 1, 2, 0], add_with_ia: [1, 1, 2, 0],
	sub: [0, 1, 3, 0], jmp: [-1, 4, 15, 1], jz: [-1, 4, 15, 0],
		ja: [1, 4, 15, 0], jf0: [1, 4, 15, 1],
		jf1: [1, 4, 15, 0], stop: [1, 4, 15, 0] }
